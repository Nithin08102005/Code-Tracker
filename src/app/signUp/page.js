      ...
      <div className="w-full max-w-md relative z-10">
        <div className="mb-6 flex flex-col items-center">
          ...
          <p className="text-base text-muted-foreground mt-2">
            Create an account to track your coding progress
          </p>
        </div>
        ...
        <div className="bg-card/50 backdrop-blur-sm border border-primary/10 hover:border-primary/20 transition-all duration-300 shadow-xl shadow-primary/5 rounded-lg overflow-hidden">
          <div className="h-1 w-full bg-gradient-to-r from-blue-500 via-violet-500 to-primary"></div>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                >
                  <User className="h-3.5 w-3.5 mr-1.5 text-blue-500/70" />
                  Username
                </Label>
                <div className="relative">
                  <Input
                    ...
                    id="username"
                    name="username"
                    className="pl-9 bg-background border border-input rounded-md focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30 transition-all"
              ...
              <Button
                type="submit"
                className={`w-full py-5 bg-gradient-to-r from-blue-600 to-primary dark:from-blue-600 dark:to-violet-500 text-white font-medium rounded-md flex items-center justify-center gap-2 transform transition-all duration-300 hover:-translate-y-0.5 ${
              ...
              >
                {pending ? (
                  ...
                  <UserPlus className="h-5 w-5 mr-2 text-white dark:text-gray-900" />
                )}
                <span className="text-white dark:text-gray-900">{pending ? "Creating Account..." : "Create Account"}</span>
              </Button>
            </form>
